...
public class PreferencesDataManagerFactory {
	 ...
	 */
	public static PreferencesDataManager createPreferenceManager(String sourceId, Properties props, Environment environment) throws InstantiationException, IllegalAccessException, NoSuchMethodException, SecurityException,
	IllegalArgumentException, InvocationTargetException {
		if (sourceId == null || sourceId.isEmpty() || registeredDataSources.get(sourceId) == null)
			...
			if (registeredDataSources.get(sourceId).equals(ServerPreferencesManager.class)) {
				Constructor<ServerPreferencesManager> constructor = ServerPreferencesManager.class.getConstructor(String.class, String.class, String.class);
