...
public class SigninController {
	...
	public String user_authorization(WebRequest request) {
		...
		String redirectUrl = environment.getProperty("flowManager.oauth_url") + environment.getProperty("flowManager.authorization");
	...
	private String exchange_code_for_access_token( WebRequest request ) throws Exception{
		...
		HttpPost post = new HttpPost(environment.getProperty("flowManager.oauth_url") + environment.getProperty("flowManager.exchange_accesstoken"));
	...
	private String getGpiiToken( String accessToken ) throws Exception{
		...
		HttpClient client = new DefaultHttpClient();
		HttpGet request = new HttpGet( environment.getProperty("flowManager.oauth_url") + environment.getProperty("flowManager.preferences"));
		...
		int fromIndex = result.indexOf( "gpiiToken=" ) + "gpiiToken=".length();
		int toIndex = result.indexOf(" oauth2ClientId", fromIndex);
