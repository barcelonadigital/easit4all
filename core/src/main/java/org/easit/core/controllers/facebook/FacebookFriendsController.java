...
public class FacebookFriendsController {
	...
	public String manageFriendshipRequest(@PathVariable("friendId") String friendId, String uri, HttpServletRequest request) {
		...
		//TODO: redirect to the source page!!
		//redirect:http://www.facebook.com/dialog/friends/?id=100000695485735&app_id=104811859728370&redirect_uri=http%3A%2F%2Flocalhost%3A8080%2Fasit%2Ffacebook%2Fnotifications
		String str1 = "redirect:" + facebook.friendOperations().manageFriendshipRequest(friendId, environment.getProperty("facebook.clientId"), request.getHeader("referer"));		
		return "redirect: http://www.facebook.com/dialog/friends/?id=" + friendId + "&app_id=" + environment.getProperty("facebook.clientId") +"&redirect_uri=http://www.facebook.com";
	}
